...
# Map pose markers: ~6 m tip-to-tip in world space; min ~26 px when zoomed out.
MAP_MARKER_HALF_LEN_M = 3.0
MAP_MARKER_WIDTH_RATIO = 0.4
MAP_MARKER_MIN_HALF_LEN_PX = 13.0
