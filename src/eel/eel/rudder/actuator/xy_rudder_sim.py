...
class XYRudderSim(XYRudder):
    def __init__(self, x_options: ServoOptions, y_options: ServoOptions) -> None:
        self.x_servo_offset = x_options["offset"]
        self.x_servo_cap_min = x_options["cap_min"]
        self.x_servo_cap_max = x_options["cap_max"]

        self.y_servo_offset = y_options["offset"]
        self.y_servo_cap_min = y_options["cap_min"]
        self.y_servo_cap_max = y_options["cap_max"]
